...
- Onboard ที่ IDP
  - การที่ IdP หนึ่งๆจะสามารถยืนยัน consent ให้ user ใดๆได้ user คนนั้นต้องไปทำธุกรรมเพื่ออนุญาตก่อน
...
อธิบายเรื่อง mode 1, mode 3 คร่าวๆ ว่าต้อง onboard และข้อดีข้อเสีย
